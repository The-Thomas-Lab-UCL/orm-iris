...
class mapping_method_rectxy_scan_constz_around_a_point(tk.Frame):
...
def test_rect2():
    ...
    mapping_method = mapping_method_rectxy_scan_constz_around_a_point(root,motion_controller,status_bar)
    mapping_method.pack()
