...
class Ui_gridify_setup(object):
    def setupUi(self, gridify_setup):
        ...
        QWidget.setTabOrder(self.spin_tl_z, self.spin_tr_x)
        QWidget.setTabOrder(self.spin_tr_x, self.spin_tr_y)
        QWidget.setTabOrder(self.spin_tr_y, self.spin_tr_z)
        QWidget.setTabOrder(self.spin_tr_z, self.spin_bl_x)
        QWidget.setTabOrder(self.spin_bl_x, self.spin_bl_y)
        QWidget.setTabOrder(self.spin_bl_y, self.spin_bl_z)
        QWidget.setTabOrder(self.spin_bl_z, self.spin_br_x)
        QWidget.setTabOrder(self.spin_br_x, self.spin_br_y)
        QWidget.setTabOrder(self.spin_br_y, self.spin_br_z)
        QWidget.setTabOrder(self.spin_br_z, self.btn_currcoor_tl)
        QWidget.setTabOrder(self.btn_currcoor_tl, self.btn_currcoor_tr)
        QWidget.setTabOrder(self.btn_currcoor_tr, self.btn_currcoor_bl)
        QWidget.setTabOrder(self.btn_currcoor_bl, self.btn_currcoor_br)
        QWidget.setTabOrder(self.btn_currcoor_br, self.combo_tl_xy)
        QWidget.setTabOrder(self.combo_tl_xy, self.combo_tl_z)
        QWidget.setTabOrder(self.combo_tl_z, self.combo_tr_xy)
        QWidget.setTabOrder(self.combo_tr_xy, self.combo_tr_z)
        QWidget.setTabOrder(self.combo_tr_z, self.combo_bl_xy)
        QWidget.setTabOrder(self.combo_bl_xy, self.combo_bl_z)
        QWidget.setTabOrder(self.combo_bl_z, self.combo_br_xy)
