...
class Ui_meaCoor_Rect_StartEnd(object):
    def setupUi(self, meaCoor_Rect_StartEnd):
        ...
        QWidget.setTabOrder(self.ent_starty_um, self.btn_curr_start_xy)
        QWidget.setTabOrder(self.btn_curr_start_xy, self.ent_endx_um)
        QWidget.setTabOrder(self.ent_endx_um, self.ent_endy_um)
        QWidget.setTabOrder(self.ent_endy_um, self.btn_curr_end_xy)
        QWidget.setTabOrder(self.btn_curr_end_xy, self.ent_z_um)
        QWidget.setTabOrder(self.ent_z_um, self.btn_curr_z)
        QWidget.setTabOrder(self.btn_curr_z, self.ent_res_pt_x)
