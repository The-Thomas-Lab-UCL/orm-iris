...
class Ui_meaCoor_Rect_StartEnd(object):
    def setupUi(self, meaCoor_Rect_StartEnd):
        ...
        meaCoor_Rect_StartEnd.resize(565, 419)
        self.gridLayoutWidget = QWidget(meaCoor_Rect_StartEnd)
        self.gridLayoutWidget.setObjectName(u"gridLayoutWidget")
        self.gridLayoutWidget.setGeometry(QRect(20, 10, 531, 381))
        ...
        self.gridLayout.addWidget(self.label_13, 4, 0, 1, 3)

        self.ent_res_um_y = QLineEdit(self.gridLayoutWidget)
        self.ent_res_um_y.setObjectName(u"ent_res_um_y")

        self.gridLayout.addWidget(self.ent_res_um_y, 8, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_16, 6, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.ent_res_pt_y, 7, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_curr_start_xy, 0, 3, 1, 3)
        ...
        self.gridLayout.addWidget(self.btn_curr_z, 4, 3, 1, 3)
        ...
        self.gridLayout.addWidget(self.ent_endx_um, 3, 1, 1, 1)

        self.label_20 = QLabel(self.gridLayoutWidget)
        self.label_20.setObjectName(u"label_20")

        self.gridLayout.addWidget(self.label_20, 8, 3, 1, 1)

        self.ent_z_um = QLineEdit(self.gridLayoutWidget)
        self.ent_z_um.setObjectName(u"ent_z_um")

        self.gridLayout.addWidget(self.ent_z_um, 5, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.ent_res_um_x, 8, 1, 1, 1)

        self.ent_endy_um = QLineEdit(self.gridLayoutWidget)
        self.ent_endy_um.setObjectName(u"ent_endy_um")

        self.gridLayout.addWidget(self.ent_endy_um, 3, 4, 1, 1)

        self.label_21 = QLabel(self.gridLayoutWidget)
        self.label_21.setObjectName(u"label_21")

        self.gridLayout.addWidget(self.label_21, 7, 3, 1, 1)
    ...
    def retranslateUi(self, meaCoor_Rect_StartEnd):
        ...
        self.btn_curr_start_xy.setText(QCoreApplication.translate("meaCoor_Rect_StartEnd", u"Insert current XY coordinates", None))
        ...
        self.btn_curr_end_xy.setText(QCoreApplication.translate("meaCoor_Rect_StartEnd", u"Insert current XY coordinates", None))
