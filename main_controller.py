...
from library.app.sframe_hilvl_coorGen import Frm_CoorGenerator, MappingCoordinatesHub

from library.app.shortcut_handler import ShortcutHandler

from library.data_related.MappingCoordinates import MappingCoordinatesHub

from library.calibration.calibration_generator import Frm_SpectrometerCalibrationGenerator
...
from main_analyser import A2SSM_analyser

from library.controllers import SpectrometerController,XYController,ZController

# Import the enums
from library import LibraryConfigEnum
from library.controllers import ControllerConfigEnum
from library.app import ShortcutsEnum
...
class controller_app(tk.Tk):
    ...
    def __init__(self,
                 processor:mpp.Pool,
                 raman_controller:SpectrometerController,
                 xy_controller:XYController,
                 z_controller:ZController,
                 raman_hub:RamanMeasurementHub,
                 stage_hub:stage_measurement_hub):
    ...
    # > Main setups <
        ...
        self._coorHub = MappingCoordinatesHub()
...
if __name__ == '__main__':
    ...
    stageHub = stage_measurement_hub(xyControllerProxy,zControllerProxy,camControllerProxy,stage_namespace)
    ramanHub.start()
    stageHub.start()
