...
from library.general_functions import read_update_config_file_section
...
if ControllerConfigEnum.SPECTROMETER_CONTROLLER.value == 'qepro':
    ...
    from .raman_spectrometer_controller_dummy import SpectrometerController_Dummy as SpectrometerController
...
if ControllerConfigEnum.STAGEXY_CONTROLLER.value == 'm30xym':
    ...
    from .xy_stage_controller_dummy import XYController_Dummy as XYController
...
if ControllerConfigEnum.STAGEZ_CONTROLLER.value == 'z825b':
    ...
    from .z_stage_controller_dummy import ZController_Dummy as ZController