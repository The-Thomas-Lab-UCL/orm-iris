...
class RamanMeasurement_Handler():
    """
    Saves the measurement data into a file (from the class raman_measurement)
    """
    def save_measurement_to_txt(self,measurement:RamanMeasurement,filepath:str,save_raw:bool=False):
        """
    ...
    def save_measurement_to_pickle(self,measurement:RamanMeasurement,filepath:str,savename:str):
        """
...
class RamanMeasurement_Plotter():
    """
    ...
    def plot_RamanMeasurement(self,measurement:RamanMeasurement|None=None,title='Spectra',
        ...
        if not isinstance(measurement,RamanMeasurement): return np.full((plt_size[0],plt_size[1], 3), 255, dtype=np.uint8)
    ...
    def plot_with_scatter_RamanMeasurement(self, measurement:RamanMeasurement|None,
        ...
        # Check if the given 'spectra' variable is a measurement. Otherwise, returns an white image
        if not isinstance(measurement,RamanMeasurement):
            return fig,ax
...
def test():
    ...
    raman = RamanMeasurement(reconstruct=True)
