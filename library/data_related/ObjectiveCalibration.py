...
@dataclass
class ImageMeasurement_Calibration:
...
class ImageMeasurement_Calibration_Hub():
    """
    ...
    def get_calibration(self,cal_id:str) -> ImageMeasurement_Calibration:
        """
...
def generate_dummy_calibrationHub() -> ImageMeasurement_Calibration_Hub:
    """
    ...
    """
    calhub = ImageMeasurement_Calibration_Hub()
