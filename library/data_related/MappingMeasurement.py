...
class MappingMeasurement_Unit():
    ...
    def get_laser_params(self) -> tuple[float,float]:
        ...
        power_key,wavelength_key = RamanMeasurement(reconstruct=True).get_laserMetadata_key()
    ...
    def append_ramanmeasurement_data(self,timestamp:int,coor:tuple[float,float,float],measurement:RamanMeasurement):
        """
        Appends the measurement data into the list of stored measurements.
        ...
        """
        assert isinstance(measurement, RamanMeasurement), 'append_measurement_data: The input data type is not correct. Expected raman_measurement object.'
    ...
    def get_RamanMeasurement(self,measurement_id:int|str) -> RamanMeasurement:
        """
        ...
        mea = RamanMeasurement(reconstruct=True)
...
class MappingMeasurement_Hub():
    ...
    def copy_mapping_unit(self,source_unit_id:str,dest_unit_name:str,appendToHub:False) -> MappingMeasurement_Unit:
        """
        ...
        source_unit:MappingMeasurement_Unit
        
        # Construct the destination unit
        dest_unit:MappingMeasurement_Unit = MappingMeasurement_Unit()
    ...
    def get_list_MappingUnit(self) -> list[MappingMeasurement_Unit]:
        """
    ...
    def get_MappingUnit(self,unit_id:str|None=None, unit_name:str|None=None) -> MappingMeasurement_Unit:
        """
    ...
    def append_mapping_unit(self,mapping_unit:MappingMeasurement_Unit) -> None:
        """
        ...
        """
        assert isinstance(mapping_unit, MappingMeasurement_Unit), 'append_mapping_measurement_unit: The input data type is not correct. Expected mapping_measurement_unit object.'
    ...
    def rename_mapping_unit(self,unit_id:str,new_name:str) -> None:
        ...
        unit:MappingMeasurement_Unit = self._dict_mappingMeasurementUnits['measurement_unit'][unit_idx]
    ...
    def test_generate_dummy(self):
        ...
        """
        for i in range(10):
            unit = MappingMeasurement_Unit(unit_name='dummy {}'.format(i))
            unit.test_generate_dummy()
            self.append_mapping_unit(unit)
        
class MappingMeasurement_Handler():
    """
    ...
    def _save_MappingMeasurementUnit_metadata_database(self,mappingUnit:MappingMeasurement_Unit,conn:sql.Connection) -> None:
        """
        ...
        """
        assert isinstance(mappingUnit, MappingMeasurement_Unit), '_save_mapping_measurement_unit_database: The input data type is not correct. Expected mapping_measurement_unit object.'
    ...
    def _save_MappingMeasurementUnit_measurement_database(
        self,mappingUnit:MappingMeasurement_Unit,conn:sql.Connection,conn_path:str) -> None:
        """
    ...
    def save_MappingUnit_ext_prompt(self,mappingUnit:MappingMeasurement_Unit,flg_saveraw:bool) -> threading.Thread|None:
        """
        ...
        """
        assert isinstance(mappingUnit, MappingMeasurement_Unit), 'save_mapping_unit_txt: The input data type is not correct. Expected mapping_measurement_unit object.'
    ...
    @thread_assign
    def _save_MappingUnit_ext(self,mappingUnit:MappingMeasurement_Unit,filepath:str,flg_saveraw:bool,extension:str)\
        -> threading.Thread:
        """
    ...
    def save_MappingMeasurementHub_choose(self,mappingHub:MappingMeasurement_Hub,
        ...
        Returns:
            threading.Thread: thread of the saving process
        """
        assert isinstance(mappingHub, MappingMeasurement_Hub), 'save_mapping_measurement: The input data type is not correct. Expected mapping_measurement_new object.'
    ...
    @thread_assign
    def save_MappingHub_database(self,mappingHub:MappingMeasurement_Hub,savedirpath:str,savename:str) -> threading.Thread:
        """
    ...
    @thread_assign
    def save_MappingHub_pickle(self,mappingHub:MappingMeasurement_Hub,savedirpath:str,
    ...
    def _load_MappingMeasurementUnit_metadata_database(self,unit_id:str,conn:sql.Connection,
                                                       mappingUnit:MappingMeasurement_Unit) -> MappingMeasurement_Unit:
        """
    ...
    def _load_MappingMeasurementUnit_measurement_database(self,unit_id:str,conn:sql.Connection,conn_path:str,
        mappingUnit:MappingMeasurement_Unit,flg_readraw:bool) -> MappingMeasurement_Unit:
        """
    ...
    def load_MappingMeasurementHub_database(self,hub:MappingMeasurement_Hub,loadpath:str,
        flg_readraw:bool=True) -> MappingMeasurement_Hub:
        """
        ...
        for unit_id in dict_unit_id_to_name.keys():
            ...
            mappingUnit = MappingMeasurement_Unit(unit_name=unit_name,unit_id=unit_id)
    ...
    def load_MappingMeasurement_pickle(self,hub:MappingMeasurement_Hub,loadpath:str) -> MappingMeasurement_Hub:
        """
        ...
        with open(loadpath, 'rb') as file:
            mapping_measurement:MappingMeasurement_Hub = dill.load(file)
    ...
    def load_choose(self,mappingHub:MappingMeasurement_Hub,callback_fast:Callable|None=None,
    ...
    def test_database_save_load(self,hub:MappingMeasurement_Hub):
        """
...
def generate_dummy_mappingHub(numx:int=6,numy:int=8,repeat:int=3) -> MappingMeasurement_Hub:
    """
    ...
    Returns:
        mapping_measurement_new: mapping_measurement object
    """
    from library.controllers.raman_spectrometer_controller_dummy import SpectrometerController_Dummy as raman_spectrometer_controller
    import numpy as np
    ...
    storage_unit = MappingMeasurement_Unit(unit_name='dummy'+get_timestamp_sec())
    max_len = len(listx)*len(listy)
    i=0
    for x in listx:
        for y in listy:
            # Generate the measurements
            mea_single = RamanMeasurement(timestamp=get_timestamp_us_int(),int_time_ms=10,
    ...
    storage_main = MappingMeasurement_Hub()
...
class MappingMeasurement_Plotter:
    """
    ...
    def plot_typehinting(self, mapping_unit:MappingMeasurement_Unit|None=None, wavelength:float|None=None,
    ...
    def plot_heatmap_nothing(self, mapping_unit:MappingMeasurement_Unit|None=None, wavelength:float|None=None,
                     clim:tuple[float,float]|None=None,title = '2D Mapping', fig:Figure|None=None, ax:Axes|None=None,
                     clrbar:Colorbar|None=None) -> tuple[Figure,Axes,Colorbar]:
        """
        ...
        Returns:
            tuple: (figure, axis, clrbar) of the plot
        """
        if isinstance(mapping_unit,MappingMeasurement_Unit) and wavelength is not None:    
        ...
        if any([not isinstance(mapping_unit,MappingMeasurement_Unit), wavelength is None]):
            return (fig,ax,None)
    ...
    def plot_heatmap_interp(self, mapping_unit:MappingMeasurement_Unit|None=None, wavelength:float|None=None,
                     clim:tuple[float,float]|None=None,title = '2D Mapping', fig:Figure|None=None, ax:Axes|None=None,
                     clrbar:Colorbar|None=None) -> tuple[Figure,Axes,Colorbar]:
        """
        Plots a heatmap plot from a mapping unit, given its coordinates, and labels indicating the data column info.
    ...
    def plot_heatmap_scatter(self, mapping_unit:MappingMeasurement_Unit|None=None, wavelength:float|None=None,
...
def test_datasaveload_system_txt(storage_main:MappingMeasurement_Hub|None=None):
    if storage_main is None: storage_main = generate_dummy_mappingHub()
    
    handler = MappingMeasurement_Handler()
...
def test_datasaveload_system(storage_main:MappingMeasurement_Hub|None=None):
...
def test_mappingHub():
    ...
    """
    dummy_hub = MappingMeasurement_Hub()
