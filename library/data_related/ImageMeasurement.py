...
from library.data_related.ObjectiveCalibration import ImageMeasurement_Calibration, ImageMeasurement_Calibration_Hub

from library.data_related import SaveParamsEnum, ImageProcessingParamsEnum

class ImageMeasurement_Unit():
    """
    ...
    """
    def __init__(self,unit_name:str|None=None,calibration:ImageMeasurement_Calibration|None=None,
        ...
        """
        if not reconstruct:
            assert isinstance(calibration, ImageMeasurement_Calibration), 'Calibration must be an ImageMeasurement_Calibration object'
        ...
        self._calibration:ImageMeasurement_Calibration = calibration
    ...
    def get_ImageMeasurement_Calibration(self) -> ImageMeasurement_Calibration:
        """
    ...
    def set_calibration_ImageMeasurement_Calibration(self,calibration:ImageMeasurement_Calibration) -> None:
        """
...
class ImageMeasurement_Hub():
    ...
    def get_summary_units(self) -> tuple[list,list]:
        ...
        """
        list_units:list[ImageMeasurement_Unit] = self._dict_ImageUnits['image_unit']
    ...
    def append_ImageMeasurementUnit(self,unit:ImageMeasurement_Unit) -> None:
        """
        ...
        """
        assert isinstance(unit, ImageMeasurement_Unit), 'Unit must be an ImageMeasurement_Unit object'
    ...
    def get_ImageMeasurementUnit(self,unit_id:str) -> ImageMeasurement_Unit:
        """
    ...
    def test_generate_dummy(self):
        ...
        for i in range(5):
            unit = ImageMeasurement_Unit(reconstruct=True)
...
class ImageMeasurement_Handler():
    """
    ...
    def save_calibration_json(self,calibration:ImageMeasurement_Calibration) -> tuple[str,str]|None:
        """
    ...
    def load_calibration_json(self) -> ImageMeasurement_Calibration|None:
        """
    ...
    def save_calibration_json_from_ImgMea(self,measurement:ImageMeasurement_Unit,savename:str=None):
        """
        Saves the calibration parameters to a JSON file
    ...
    @thread_assign
    def save_ImageMeasurementHub_database(self,hub:ImageMeasurement_Hub,initdir:str,savename:str) -> threading.Thread:
        """
        ...
        """
        assert isinstance(hub, ImageMeasurement_Hub), 'Hub must be an image measurement hub object'
    ...
    def save_ImageMeasurementUnit_database(\
        self,unit:ImageMeasurement_Unit,conn:sql.Connection,conn_path:str):
        """
    ...
    def _save_ImageMeasurementUnit_measurement_database(
        self,unit:ImageMeasurement_Unit,conn:sql.Connection,
        conn_path:str) -> None:
        """
        Saves the measurements to a database connected
        ...
        """
        assert isinstance(unit, ImageMeasurement_Unit), 'Unit must be an image measurement unit object'
    ...
    def _save_ImageMeasurementUnit_metadata_database(self,unit:ImageMeasurement_Unit,conn:sql.Connection) -> None:
        """
    ...
    def load_ImageMeasurementHub_database(self,loadpath:str,hub:ImageMeasurement_Hub|None=None)\
        ...
        if not isinstance(hub, ImageMeasurement_Hub): hub = ImageMeasurement_Hub()
        ...
        unit = ImageMeasurement_Unit(None,None,reconstruct=True)
    ...
    def load_ImageMeasurementUnit_database(self,unit:ImageMeasurement_Unit,
        unit_id:str,conn:sql.Connection,conn_path:str) -> ImageMeasurement_Unit:
        """
...
def test():
    cal = ImageMeasurement_Calibration('test cal')
    cal.generate_dummy_params()
    
    hub = ImageMeasurement_Hub()
    for i in range(3):
        unit = ImageMeasurement_Unit('test unit {}'.format(i),calibration=cal)
        unit.test_generate_dummy()
        hub.append_ImageMeasurementUnit(unit)
        
    handler = ImageMeasurement_Handler()
