...
from library.data_related.MappingMeasurement import MappingMeasurement_Hub, MappingMeasurement_Unit
from library.data_related.RamanMeasurement import RamanMeasurement, RamanMeasurement_Plotter

from library.app.sframe_dataHubMapping import Frm_DataHub_Mapping, Frm_DataHub_Mapping_Plus
from library.app.submodules.ssframe_RMPlotter_peakfinding import Frm_RamanMeasurement_Plotter
...
class sFrm_wavelength_calibration(tk.Frame):
    ...
    # >> Calibration parameters setup <<
        self._mea_RM:RamanMeasurement = None    # The selected RamanMeasurement for the calibration
    ...
    def _plot_transfer_func(self,list_peakRS_mea:list[float],list_peakRS_ref:list[float]):
        ...
        mea = self._mea_RM
        if not isinstance(mea,RamanMeasurement): return
