...
from library.data_related.RamanMeasurement import RamanMeasurement, RamanMeasurement_Plotter
...
from library.multiprocessing.basemanager import MyManager, get_my_manager

from library.controllers import SpectrometerController
...
class Frm_RamanSpectrometerController(tk.Frame):
    ...
    """
    def __init__(self, parent,processor:mpp.Pool,controller:SpectrometerController,
                 ramanHub:RamanMeasurementHub, dataHub:Frm_DataHub_Mapping,main:bool=False):
        """
...
# >>> Spectrometer control and data handling setup <<<
        ...
        self._sgl_measurement:RamanMeasurement = None   # single measurement
        self._con_measurement:RamanMeasurement = None   # continuous measurement
        
        # Plotter setup
        self._plotter = RamanMeasurement_Plotter()
...
# >>> Measurement control widgets setup <<<
    ...
    def Analyse(self,measurement:RamanMeasurement,raw_list:list):
        """
    ...
    def AnalyseAndPlot_rawlist(self,measurement:RamanMeasurement,
    ...
    def Plot_rawlist_RM(self,measurement:RamanMeasurement,plot_add_kwargs:dict={}):
        """
    ...
    def perform_continuous_measurement(self,widget_override=False,waitforplot=True,store_all=False,delay:int=0,queue_response:queue.Queue=None):
        ...
        # Initializes the measurement
        measurement = RamanMeasurement(timestamp=get_timestamp_us_int(),int_time_ms=int_time_ms,
    ...
    def _perform_ContinuousMeasurement_trigger(self,q_trigger:queue.Queue,q_return:queue.Queue) -> threading.Thread:
        ...
        # Initialise the analyser and plotter
        measurement = RamanMeasurement(timestamp=get_timestamp_us_int(),
        ...
        while self._flg_isrunning.is_set(): # Run till stopped
            ...
            for ts_int,spectrum_raw,int_time_ms in zip(list_timestamp_mea_int,list_spectrum,list_integration_time_ms):
                ...
                measurement = RamanMeasurement(timestamp=ts_int,int_time_ms=int_time_ms,
                    laserPower_mW=self._laserpower_mW,laserWavelength_nm=self._laserwavelength_nm)
    ...
    def perform_single_measurement_manual(self,widget_override=False,queue_response:queue.Queue=None,
        ...
        self._sgl_measurement = RamanMeasurement(timestamp=get_timestamp_us_int(),
            int_time_ms=int_time_ms, laserPower_mW=self._laserpower_mW,laserWavelength_nm=self._laserwavelength_nm)
...
if __name__ == '__main__':
    ...
    RamanHub = RamanMeasurementHub(RamanController_proxy,dict_MeaRaman_proxy)
    RamanHub.start()
