...
# Import DataHubs
from library.app.sframe_dataHubImage import Frm_DataHub_ImgCal

# Import measurements
from library.data_related.ImageMeasurement import ImageMeasurement_Unit, ImageMeasurement_Hub, ImageMeasurement_Handler
from library.data_related.ObjectiveCalibration import ImageMeasurement_Calibration
from library.data_related.MappingMeasurement import MappingMeasurement_Hub,MappingMeasurement_Unit,MappingMeasurement_Plotter

# Import processors
from library.app.submodules.ssframe_mapping_plot_heatmap import Frm_MappingMeasurement_Plotter

# Import extensions
from library.app.image_calibration.frm_calibration import sFrm_CalibrationAdjustment

# Import enums
from library.app import AppPlotEnum

class MappingPlotter_ImageOverlay(MappingMeasurement_Plotter):
    """
...
class Frm_HeatmapOverlay(Frm_MappingMeasurement_Plotter):
    ...
    def __init__(
        ...
        master,
        processor:mpp.Pool,
        mappingHub:MappingMeasurement_Hub,
        imghub_getter:Callable[[],ImageMeasurement_Hub],
    ...
    def _initialise_img_combobox(self):
        ...
        if not isinstance(imghub,ImageMeasurement_Hub): print('_initialise_img_combobox: Invalid image measurement hub object.'); return
    ...
    def _finetune_calibration(self) -> None:
        ...
        try:
            ...
            if not isinstance(meaImg,ImageMeasurement_Unit): return
            ...
            if not flg_save: messagebox.showinfo('Calibration changes','Calibration changes are not saved.')
                ...
                new_cal.id = new_id
                ImageMeasurement_Handler().save_calibration_json(new_cal)
    ...
    def _get_ImageUnit(self) -> ImageMeasurement_Unit|None:
        """
    ...
    def plot_heatmap(self,img_unit:ImageMeasurement_Unit|None=None,autoplot:bool=True) -> None:
        """
        ...
        """
        def correct_MappingMeasurementCoordinates(mapping_unit:MappingMeasurement_Unit,
                measurement_img:ImageMeasurement_Unit) -> MappingMeasurement_Unit:
        ...
        if not isinstance(img_unit,ImageMeasurement_Unit): img_unit = self._get_ImageUnit()
        
        if not isinstance(mapping_hub,MappingMeasurement_Hub): return
        if not isinstance(img_unit,ImageMeasurement_Unit): return
