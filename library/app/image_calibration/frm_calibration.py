...
class sFrm_CaptureAndCalibration(tk.Frame):
    ...
    # >>> Main parameters <<<
        ...
        self._meaImgUnit = ImageMeasurement_Unit(
    ...
    def _perform_calibration(self):
        ...
        # > 7. Select the tracking features <
            ...
            cal = ImageMeasurement_Calibration('calibration')
            ...
            self._meaImgUnit = ImageMeasurement_Unit(unit_name='Calibration',calibration=cal)
        ...
        # > 7. Ask the user to save the calibration file
            ...
            ImageMeasurement_Handler().save_calibration_json_from_ImgMea(self._meaImgUnit)
...
class sFrm_CalibrationAdjustment(tk.Frame):
    ...
    """
    def __init__(self, main, processor:mpp.Pool, imgUnit_getter:Callable[[],ImageMeasurement_Unit],
    ...
    # >>> Image file handler <<<
        ...
        self._handler_img = ImageMeasurement_Handler()
    ...
    # Auto calibration process related
        # Calibration objects
        self._cal_ori:ImageMeasurement_Calibration = None
        self._cal_temp:ImageMeasurement_Calibration = None
        self._cal_final:ImageMeasurement_Calibration = None
    ...
    def initialise_fineadjuster(self) -> None:
        ...
        assert isinstance(self._cal_ori, ImageMeasurement_Calibration), 'Calibration object not initialised'
        assert self._cal_ori.check_calibration_set() == True, 'Calibration parameters not set'
        
    def get_final_calibration(self) -> ImageMeasurement_Calibration|None:
        """
    ...
    def apply_temp_fineadjustment(self) -> None:
        ...
        self._cal_temp = ImageMeasurement_Calibration(id=id)
