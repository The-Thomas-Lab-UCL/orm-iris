...
from library.app import AppPlotEnum, AppVideoEnum
from library.controllers import ControllerConfigEnum
from library.controllers import CameraController, XYController, ZController
...
class Frm_MotionController(tk.Frame):
    ...
    def __init__(self,parent,xy_controller:XYController,z_controller:ZController,
                 stageHub:stage_measurement_hub,getter_imgcal:Callable[[],ImageMeasurement_Calibration],
                 flg_issimulation=True, main:bool=False):
        # Initialise the class
        super().__init__(parent)
        self._stageHub:stage_measurement_hub = stageHub
...
def generate_dummy_motion_controller(parent:tk.Tk|tk.Frame) -> Frm_MotionController:
    ...
    from library.app.sframe_motion_video import get_my_manager, initialise_manager_stage, initialise_proxy_stage
    from library.multiprocessing.stage_measurement_hub import generate_dummy_stageHub
