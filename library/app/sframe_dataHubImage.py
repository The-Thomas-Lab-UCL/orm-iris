...
from library import LibraryConfigEnum
...
class Frm_DataHub_ImgCal(tk.LabelFrame):
    ...
    """
    def __init__(self, main, getter_ImageCalHub:Callable[[], ImageMeasurement_Calibration_Hub]|None=None,
                 *args, **kwargs) -> None:
        """
        ...
        self._CalHub = self._getter_CalHub() if self._getter_CalHub is not None else ImageMeasurement_Calibration_Hub()
        
        # List of the available calibrations
        self._list_cals = []
        self._empty_cal = ImageMeasurement_Calibration()
    ...
    def get_ImageMeasurement_Calibration_Hub(self) -> ImageMeasurement_Calibration_Hub:
        """
    ...
    def get_selected_calibration(self) -> ImageMeasurement_Calibration:
        """
...
class Frm_DataHub_Image(tk.Frame):
    ...
    """
    def __init__(self, main, getter_ImageHub: Callable[[], ImageMeasurement_Hub]|None=None,
    ...
    # >>> Hub setups <<<
        self.ImageHub = self._getter_ImageHub() \
            if self._getter_ImageHub is not None else ImageMeasurement_Hub()
    ...
    def append_ImageMeasurementUnit(self, unit:ImageMeasurement_Unit, flg_nameprompt:bool=True):
        """
    ...
    def get_ImageMeasurement_Hub(self) -> ImageMeasurement_Hub:
        """
