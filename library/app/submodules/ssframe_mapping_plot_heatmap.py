...
class Frm_MappingMeasurement_Plotter(tk.Frame):
    def __init__(self,master,mappingHub:MappingMeasurement_Hub,queue_click:queue.Queue|None=None,
        ...
        """
        assert isinstance(mappingHub,MappingMeasurement_Hub),'mappingHub must be an instance of MappingMeasurement_Hub'
        ...
        self._mappingHub:MappingMeasurement_Hub = mappingHub
    ...
    # > Parameters <
        ...
        self._mapping_Plotter = MappingMeasurement_Plotter(figsize_pxl=self._figsize_pxl)
        
        # Latest measurement data storage for plotting purposes only
        self._current_mappingUnit:MappingMeasurement_Unit = MappingMeasurement_Unit()
    ...
    def plot_heatmap(self):
        ...
        assert isinstance(self._mappingHub,MappingMeasurement_Hub),\
    ...
    def _get_closest_selected_wavelength(self, mappingUnit:MappingMeasurement_Unit) -> tuple[float,float]:
        """
    ...
    def save_plot_data(self):
        ...
        """
        try:
            if not isinstance(self._current_mappingUnit,MappingMeasurement_Unit): return
    ...
    def _retrieve_click_idxcol(self,event:matplotlib.backend_bases.MouseEvent|Any):
        ...
        """
        if event.inaxes and isinstance(self._current_mappingUnit, MappingMeasurement_Unit):
...
def test_plotter():
    from library.data_related.MappingMeasurement import generate_dummy_mappingHub, test_datasaveload_system
