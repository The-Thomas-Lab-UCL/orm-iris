...
from library.app.sframe_hilvl_coorGen import frm_Treeview_MappingCoordinates

from library.app.submodules.mappingCoor_generation_methods.ssfrm_tilemthd1_rect_around import tiling_method_rectxy_scan_constz_around_a_point as TileMethod

from library.app.image_calibration.Canvas_ROIdefinition import ImageCalibration_canvas_calibration

from library.data_related.ImageMeasurement import ImageMeasurement_Unit
...
from library.multiprocessing.stage_measurement_hub import stage_measurement_hub
...
class Frm_HiLvlTiling(tk.Frame):
    ...
    def __init__(
        ...
        assert isinstance(stageHub, stage_measurement_hub), 'stageHub must be a stage_measurement_hub object'
    ...
    def _plot_imgunit(self):
        ...
        try:
            ...
            if not isinstance(imgUnit,ImageMeasurement_Unit): raise ValueError('No ImageUnit found')
    ...
    def _get_selected_ImageUnit(self) -> ImageMeasurement_Unit:
        """
    ...
    def _take_image(self, flg_stop:threading.Event):
        ...
        if not isinstance(cal,ImageMeasurement_Calibration) or not cal.check_calibration_set():
        ...
        imgUnit = ImageMeasurement_Unit(unit_name=imgname,calibration=cal)
