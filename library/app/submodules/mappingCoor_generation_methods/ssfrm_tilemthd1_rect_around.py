...
class tiling_method_rectxy_scan_constz_around_a_point(tk.Frame):
    ...
    def __init__(
        ...
        getter_cal:Callable[[],ImageMeasurement_Calibration],
        *args, **kwargs) -> None:
    ...
    def _get_xy_scales_mmPerPixel(self) -> tuple[float,float]:
        ...
        """
        img_cal:ImageMeasurement_Calibration = self._getter_imgCal()
    ...
    def _generate_tiling_coordinates(self) -> list[tuple[float,float,float]]|None:
        ...
        if not isinstance(cal,ImageMeasurement_Calibration):
