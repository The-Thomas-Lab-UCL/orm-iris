...
from library.app.sframe_dataHubImage import Frm_DataHub_Image

from library.app.submodules.mappingCoor_generation_methods.ssfrm_mapmthd4_rect_image import mapping_method_rectxy_scan_image

class mapping_method_rectxy_scan_image_points(mapping_method_rectxy_scan_image):
    def __init__(
        self,
        container_frame,
...
def test():
    ...
    mapping_method = mapping_method_rectxy_scan_image_points(
