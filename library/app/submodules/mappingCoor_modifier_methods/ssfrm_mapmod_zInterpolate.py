...
class mapping_modifier_zInterpolate(tk.Frame):
    def __init__(
        self,
        parent,
    ...
    # > Retrieve the selected mapping unit from the combobox and check it <
        ...
        if not isinstance(mapCoor_source, MappingCoordinates_mm):
    ...
    # > Modify the z-coordinates <
        ...
        while True:
            ...
            new_mapping_coor = MappingCoordinates_mm(new_name,list_coor_interp)
...
def test():
    ...
    frm_coor_mod = mapping_modifier_zInterpolate(
        root,
