...
class mapping_modifier_translateXYZ(tk.Frame):
    def __init__(
        self,
        parent,
    ...
    def _update_reference_coordinates_label(self):
        ...
        if not isinstance(mappingCoor, MappingCoordinates_mm): self._str_refCoor.set('N/A'); return
    ...
    def _get_reference_coordinates_XY(self, mappingCoor:MappingCoordinates_mm) -> tuple[float, float]:
        ...
        """
        assert isinstance(mappingCoor, MappingCoordinates_mm), "Invalid mapping coordinates type"
    ...
    def _get_reference_coordinates_Z(self, mappingCoor:MappingCoordinates_mm) -> float:
    ...
    # > Modify the coordinates <
        ...
        while True:
            ...
            new_mapping_coor = MappingCoordinates_mm(new_name,list_new_coor)
...
def test():
    ...
    frm_coor_mod = mapping_modifier_translateXYZ(
        root,
