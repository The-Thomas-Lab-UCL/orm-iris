...
from library.app.submodules.mappingCoor_generation_methods.ssfrm_mapmthd1_rect_manual import mapping_method_rectxy_scan_constz as Map1
from library.app.submodules.mappingCoor_generation_methods.ssfrm_mapmthd2_rect_around import mapping_method_rectxy_scan_constz_around_a_point as Map2
from library.app.submodules.mappingCoor_generation_methods.ssfrm_mapmthd3_rect_video import mapping_method_rectxy_scan_video as Map3
from library.app.submodules.mappingCoor_generation_methods.ssfrm_mapmthd4_rect_image import mapping_method_rectxy_scan_image as Map4
from library.app.submodules.mappingCoor_generation_methods.ssfrm_mapmthd5_rect_image_points import mapping_method_rectxy_scan_image_points as Map5
from library.app.submodules.mappingCoor_generation_methods.ssfrm_mapmthd6_singlePointZScan import mapping_method_singlePointZScan as Map6
from library.app.submodules.mappingCoor_generation_methods.ssfrm_zscanmthd1_linear import ZScanMethod_linear as ZScan1

from library.app.submodules.mappingCoor_modifier_methods.ssfrm_mapmod_everyZCoorMod import mapping_modifier_everyZ as MapMod1
from library.app.submodules.mappingCoor_modifier_methods.ssfrm_mapmod_zInterpolate import mapping_modifier_zInterpolate as MapMod2
from library.app.submodules.mappingCoor_modifier_methods.ssfrm_mapmod_topology_visualiser import mapping_topology_visualiser as MapMod3
from library.app.submodules.mappingCoor_modifier_methods.ssfrm_mapmod_translateXYZ import mapping_modifier_translateXYZ as MapMod4
from library.app.submodules.mappingCoor_modifier_methods.ssfrm_mapmod_gridify import mapping_modifier_gridify as MapMod5

from library.general_functions import *
from library.app import AppRamanEnum, AppPlotEnum
...
from library.data_related.ImageMeasurement import ImageMeasurement_Calibration_Hub, ImageMeasurement_Hub
from library.data_related.MappingCoordinates import MappingCoordinates_mm, MappingCoordinatesHub
    
class frm_Treeview_MappingCoordinates(tk.Frame):
    """
    A class to create a treeview for the mapping coordinates.
    """
    def __init__(self, master:tk.Tk|tk.Frame, mappingCoorHub:MappingCoordinatesHub):
        """
    ...
    def get_selected_mappingCoor(self, flg_message:bool=False) -> list[MappingCoordinates_mm]:
        """
    ...
    def offload_mappingCoor(self,mapping_unitName:str,list_coor:list,idx:int) -> threading.Thread:
        ...
        mappingCoor = MappingCoordinates_mm(mapping_unitName,list_coor_temp)
    ...
    def _load_MappingCoordinates(self,list_loadpath:list[str]|None=None):
        ...
        for path in list_loadpath:
            try:
                mappingCoor = MappingCoordinates_mm(loadpath=path)
    ...
    def save_MappingCoordinates(self,autosave:bool=False,type:Literal['pickle','csv']='pickle'):
        ...
        for selection in list_selection:
            ...
            mappingCoor:MappingCoordinates_mm = self._mappingCoorHub[idx]
...
class sFrm_CoorModifier(tk.Frame):
    def __init__(
        ...
        coor_Hub:MappingCoordinatesHub):
        """
...
class Frm_CoorGenerator(tk.Frame):
    ...
    # >>> Shortcuts setup <<<
        self._list_shorcuts:list[Callable[[MappingCoordinates_mm,None]]] = []    # List of shortcuts for other objects to use. It will be a list of functions that take a MappingCoordinates_mm object as an argument.
    ...
    def add_shortcut(self, btn_label:str, command:Callable[[MappingCoordinates_mm],None]):
        """
    ...
    def generate_current_mapping_coordinates(self) -> MappingCoordinates_mm:
        """
        ...
        return MappingCoordinates_mm(mappingUnit_name=unit_name, mapping_coordinates=mapping_coordinates)
    ...
    def _generate_mapping_coordinate(self):
        ...
        mappingCoor = MappingCoordinates_mm(mappingUnit_name,mapping_coordinates)
    ...
    def _generate_mapping_coordinate_zscan(self):
        ...
        list_mappingCoor = [
            MappingCoordinates_mm(mappingUnit_name=name,mapping_coordinates=coor)
...
def generate_dummy_sfrmCoorGenerator(
    ...
    datahub_img:ImageMeasurement_Hub|None=None,
    datahub_imgcal:ImageMeasurement_Calibration_Hub|None=None
    ) -> Frm_CoorGenerator:
    """
    ...
    """
    from library.app.sframe_motion_video import generate_dummy_motion_controller
    from library.data_related.ObjectiveCalibration import generate_dummy_calibrationHub
    from library.app.sframe_dataHubImage import generate_dummy_frmImageHub, generate_dummy_frmImgCalHub
    from library.app.sframe_dataHubMapping import generate_dummy_frmMappingHub
