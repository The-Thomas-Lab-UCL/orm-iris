...
from library.app.sframe_hilvl_coorGen import Frm_CoorGenerator

from library.app.image_calibration.frm_HeatmapOverlayPlotter import Frm_HeatmapOverlay
from library.app.image_calibration.frm_calibration import sFrm_CaptureAndCalibration
from library.app.submodules.ssframe_imageTiling import Frm_HiLvlTiling
from library.multiprocessing.stage_measurement_hub import stage_measurement_hub

from library.data_related.MappingCoordinates import MappingCoordinatesHub, MappingCoordinates_mm
...
class Frm_HighLvlController_Brightfield(tk.Frame):
    ...
    def __init__(
        ...
        assert isinstance(dataHub_map, Frm_DataHub_Mapping), 'DataHub must be a Frm_DataHub object'
