...
from .general_functions import read_update_config_file_section
...
class DataAnalysisConfigEnum(Enum):
    ...
    SIMILARIY_THRESHOLD = dict_dataAnalysis_read['similarity_threshold']
