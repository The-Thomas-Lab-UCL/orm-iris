...
from library.calibration.calibration_generator import CalibrationParams, SpectrometerCalibrator, Frm_SpectrometerCalibrationGenerator
...
class RamanMeasurementHub(mp.Process):
    """
    ...
    def __init__(self,controller:SpectrometerController,dict_measurements:mpm.DictProxy):
        """
        Args:
...
def initialise_manager_raman(manager:MyManager):
    ...
    """
    manager.register('raman_controller_proxy',callable=SpectrometerController)
...
def test_initialise_cal_hub():
    ...
    hub = RamanMeasurementHub(controller=raman_ctrl_proxy,
